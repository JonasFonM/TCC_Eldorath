    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <GeneralExplain style={'linear-gradient(to bottom, white, #07bc5d)'} color={'black'} title={'Agilidade'} description="Agilidade é usada para Acertar Ataques Físicos, além de ser a base principal da sua Defesa." isHidden={showAtr != 3} onCancel={() => setShowAtr(0)} />
            ...
            <div className="container">
                ...
                <GeneralExplain style={'linear-gradient(to bottom, white, #07bc5d)'} color={'black'} title={'Defesa'} description="Defesa reduz o Dano Físico que você recebe em um valor fixo. Ela é baseada na sua Agilidade e Itens Equipados." isHidden={showAtr != 12} onCancel={() => setShowAtr(0)} />

                <button onClick={() => setShowAtr(13)} className="block"><h1>{character.magicDefense}</h1><p className="Atr">DM</p></button>
                <GeneralExplain style={'linear-gradient(to bottom, white, #07bc5d)'} color={'black'} title={'Defesa Mágica'} description="Defesa Mágica reduz o Dano Mágico que você recebe em um valor fixo. Ela é baseada na sua Mente e Itens Equipados." isHidden={showAtr != 13} onCancel={() => setShowAtr(0)} />
