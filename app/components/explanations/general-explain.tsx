...
export function GeneralExplain({ title, description, isHidden, onCancel, style, color }: props) {
    ...
    return (
        <div className="modal-overlay" style={{ display: isHidden ? 'none' : 'flex' }}>
            <button type="button" onClick={onCancel} style={{ position: 'fixed', cursor: 'default', left: '0', top: '0', opacity: '0', width: '100%', height: '100%', zIndex: '1' }}></button>
            <div className="modal-content" style={{ backgroundImage: style }}>
