...
export default function Home() {
  ...
  return (
    <>
      ...
      <GeneralExplain style={'linear-gradient(to bottom, white, gold)'} color={'black'} title={'Æternida'} description='Æternida é um RPG "de mesa" completamente digital, centrado em um universo vasto de fantasia (principalmente) medieval inspirado em várias temáticas famosas (ou não muito) na cultura pop.' isHidden={showAtr != 1} onCancel={() => setShowAtr(0)} />
